...
import {
	divisionCodesmodern as divisionCodes,
	leadFactories,
	...
	vsmerchandisers,
	planners,
	M3buyerDivisionsVs as M3buyerDivisions
...
const Step2Component = () => {
	...
	const onInputSheetDownload = async () => {
		...
		// const NewSeason = pinkInputSheetContext.season.toUpperCase() === 'FALL' ? 'FALL-21' :
		// pinkInputSheetContext.season.toUpperCase() === 'SPRING' ? 'Sping 21' :
		// 	pinkInputSheetContext.season.toUpperCase() === 'SUMMER' ? 'Summer 21' : 'Holiday 21';
